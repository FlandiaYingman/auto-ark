...
class FgoPoints {
    ...
    static final Point SKILL_TARGET_OFFSET = new Point(16512, 20343).sub(SKILL_TARGET_1);

    static final Point SKILL_1_1 = new Point(1638, 26396);
    static final Point SKILL_SKILL_OFFSET = new Point(4121, 26396).sub(SKILL_1_1);
    static final Point SKILL_SERVANT_OFFSET = new Point(9830, 26396).sub(SKILL_1_1);

    static final Point ATTACK_TARGET_1 = new Point(13440, 2002);
    static final Point ATTACK_TARGET_OFFSET = new Point(7398, 2002).sub(ATTACK_TARGET_1);

    static final Point MASTER_SKILL_N1 = new Point(30566, 14381);
    static final Point MASTER_SKILL_N2_1 = new Point(22963, 14381);
    static final Point MASTER_SKILL_N2_OFFSET = new Point(25446, 14381).sub(MASTER_SKILL_N2_1);
    ...
    static final Point CARD_OFFSET = new Point(9591, 23361).sub(CARD_1);
