...
import dev.flandia.ark.operate.ArkOperate.刷副本结果.结果类型.*
import dev.flandia.ark.operate.OperateOperations.剿灭作战_任意
import dev.flandia.ark.operate.OperateResult.合成玉已刷满
import dev.flandia.ark.operate.OperateResult.理智已不足
import dev.flandia.ark.operate.OperateStrategy.*
import dev.flandia.ark.operate.OperateTemplates.全权委托确定界面
...
import dev.flandia.ark.operate.OperateTemplates.关卡信息界面_全权委托关闭
import dev.flandia.ark.operate.OperateTemplates.关卡信息界面_全权委托开启
import dev.flandia.ark.operate.OperateTemplates.剿灭_行动结束
import dev.flandia.ark.operate.OperateTemplates.理智不足_可使用源石
import dev.flandia.ark.operate.OperateTemplates.理智不足_可使用药剂
import dev.flandia.ark.operate.OperateTemplates.理智不足_药剂即将到期
import dev.flandia.ark.operate.OperateTemplates.等级提升
